...
class PublicationGateTest(unittest.TestCase):
    def setUp(self):
        ...
        (self.root / "dist" / "universal" / "core" / "20260714").write_bytes(
            b"<rdf/>core-bytes"
        )
        ...
        self.receipt = {
            ...
            "lockIdentity": "sha256:lock",
            "modules": [
                {
                    "module": MODULE,
                    "locator": "src/universal/core/20260714",
                    "digest": sha(b"<rdf/>core-bytes"),
                }
            ],
            "authorities": [{"name": "iana-media-types", "digest": "sha256:auth"}],
            "comparisons": [],
            "report": "run/report.json",
            "issuedAt": "20260912T000000Z",
        }
    ...
    def write_receipt(self):
        (self.reports / "qualification-receipt.json").write_text(
    ...
    def gate(self, **overrides):
        arguments = dict(
            ...
            active_artifacts=self.active,
            policy_identity="sha256:policy",
            authority_identities=(("iana-media-types", "sha256:auth"),),
            lock_identity="sha256:lock",
            dist_directory=self.root / "dist",
        )
    ...
    def test_partially_prepared_module_set_is_refused(self):
        self.active[
            "https://haddenindustries.com/ontology/policy/activation/extended"
        ] = "src/universal/extended/20260714"
