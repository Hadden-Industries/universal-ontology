...
} from "../src/universalOntologyMcpMetadata.js";
...
const STDIO_SERVER_SCRIPT_PATH = fileURLToPath(
  new URL("../scripts/runUniversalOntologyMcpStdioServer.js", import.meta.url),
);
...
describe("Universal Ontology MCP stdio source process", () => {
