...
} from "../src/ontologyQueryArtifactCanonicalBytes.js";
import { createOntologyQueryModule } from "../src/createOntologyQueryModule.js";
import { createHttpOntologyQueryArtifactReader } from "../src/httpOntologyQueryArtifactReader.js";
import { createPersistentHttpOntologyQueryArtifactRepository } from "../src/persistentHttpOntologyQueryArtifactRepository.js";
import { createPersistentOntologyQueryArtifactCache } from "../src/persistentOntologyQueryArtifactCache.js";
import { createInMemoryOntologyReleaseArtifact } from "../../../tests/fixtures/ontology-query/createInMemoryOntologyQueryFixture.js";
import { createOntologyQueryArtifactHttpFixture } from "../../../tests/fixtures/ontology-query/createOntologyQueryArtifactHttpFixture.js";
...
const PERSISTENT_HTTP_REPOSITORY_WORKER_PATH = fileURLToPath(
  new URL("./fixtures/persistent-http-repository-worker.js", import.meta.url),
);
